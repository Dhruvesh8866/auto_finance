                        ...
                        $result=mysqli_query($link,$row);
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align:center;"><?php echo $show1['inst_no']; ?></td>
                                                                <td style="text-align:center;"><?php echo $show1['amount']; ?></td>
                                                                <td style="text-align:center;"><?php echo $show1['type']; ?></td>
                                                                <td style="text-align:center;"><?php echo date('d-m-Y',strtotime($show1['pay_date'])); ?></td>
                                                                <td style="text-align:center;"><?php echo date('d-m-Y',strtotime($show1['emi_date'])); ?></td>
