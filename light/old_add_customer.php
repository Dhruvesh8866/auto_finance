...
function check_phone(){
    document.getElementById('ctr_contact').style.border="";
    var phone=document.getElementById('ctr_contact').value;
    var mob=phone.trim();
    var length=mob.length;
    if(isNaN(mob)){
        document.getElementById('ctr_contact').style.border="solid 1px red";
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="ctr_name" id="ctr_name" placeholder="Enter Custommer name" class="form-control" autocomplete="off" maxlength="50" required> 
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row"> 
                            ...
                            <div class="col-sm-9">
                                <textarea name="ctr_address" id="textarea" rows="3" class="form-control" autocomplete="off" required></textarea>
                            </div>
                            </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="tel" name="ctr_contact" id="ctr_contact" class="form-control" pattern="[0-9]{10}" title="Enter 10 digit valid mobile number" placeholder="eg. 9876543210" autocomplete="off" onblur="check_phone();">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row"> 
                            ...
                            <div class="col-sm-6">
                              <input type="tel" name="pincode" id="pincode" pattern="[0-9]{6}" maxlength="6" title="Enter 6 Digit pincode" placeholder="eg. 385456" class="form-control" required autocomplete="off" onblur="check_pincode();">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" name="vehicle_amount" id="vehicle_amount" placeholder="eg. 50000" class="form-control" required autocomplete="off">
                            </div>
                              
                            <label class="col-sm-3 col-form-label">Down Payment</label>
                            <div class="col-sm-3">
                                <input type="number" name="downpayment" id="downpayment" class="form-control" placeholder="eg. 2000" autocomplete="off">
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row"> 
                            ...
                            <div class="col-sm-3">
                                <input type="number" onkeyup="check_loan_amt()" name="file_charge" id="file_charge" class="form-control" placeholder="eg. 100" required autocomplete="off">
                            </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" name="loan_rate" id="linterest" class="form-control" placeholder="Interest value" onkeyup="cal_total(this.value)" autocomplete="off" required>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" name="emi" id="lemi" class="form-control" placeholder="monthly EMI">
                            </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" value="<?php echo date('Y-m-d'); ?>" name="loan_date" id="textfield11" class="form-control" required>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="v_reg_no" id="textfield13" pattern="[A-Z]{2}\s[0-9]{1,2}\s[A-Z]{2}\s[0-9]{1,4}" title="Enter valid Registration number" placeholder="Enter vehicle registration number" class="form-control" required autocomplete="off">
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row"> 
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="ch_no" id="textfield14" pattern="[A-Za-z0-9]{17}" title="Enter valid Chassis number" class="form-control" placeholder="Enter chassis number" required autocomplete="off" maxlength="17">
                            </div>  
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="eng_no" id="textfield15" class="form-control" placeholder="Engine no" required autocomplete="off">
                            </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="gtr_name" id="textfield18" pattern="[A-Za-z]{1,}\s[A-Za-z]{1,}" title="Please enter valid name" class="form-control" placeholder="Enter Gurantor name" required autocomplete="off">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row"> 
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="gtr_contact" id="textfield18" pattern="[0-9]{10}" title="Enter 10 digit valid mobile number" placeholder="Enter Gurantor contact"  class="form-control" required autocomplete="off">
                            </div>
                            </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="gtr_address" id="textfield19" cols="30" rows="5" class="form-control" autocomplete="off"></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row"> 
                            ...
                            <div class="col-sm-9">
                                <div class="custom-file">
                                    ...
                                    <label style="color:red;">please upload pdf file only</label>
                                </div>
                            </div>
                        </div>
                       </div>
